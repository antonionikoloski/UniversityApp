        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_foreignId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    nadvoresen = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teachers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Teachers_AspNetUsers_id_foreignId",
                        column: x => x.id_foreignId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_Teachers_TeachersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Pom1Id = table.Column<int>(type: "int", nullable: false),
                    Pom2Id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Enrollment_Teachers_TeachersId",
                        column: x => x.TeachersId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsSubjects", x => new { x.PredmetiId, x.StudentiId });
                    table.ForeignKey(
                        name: "FK_StudentsSubjects_Students_StudentiId",
                        column: x => x.StudentiId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentsSubjects_Subjects_PredmetiId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollment_TeachersId",
                table: "Enrollment",
                column: "TeachersId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_TeachersId",
                table: "Students",
                column: "TeachersId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentsSubjects_StudentiId",

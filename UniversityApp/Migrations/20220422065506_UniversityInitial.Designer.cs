...
namespace UniversityApp.Migrations
{
    ...
    [Migration("20220422065506_UniversityInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnversityApp.Models.EnrollMent", b =>
                {
                    b.HasOne("UnversityApp.Models.Students", "StudentId")
                        .WithMany("EnrolelMent")
                        .HasForeignKey("StudentIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UnversityApp.Models.Subjects", "SubjectId")
                        .WithMany("EnrolelMent")
